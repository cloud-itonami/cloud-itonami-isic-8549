# Operator Quickstart — Other education n.e.c.

Shortest path from clone to a verified local dry-run for **ISIC 8549** (`cloud-itonami-isic-8549`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-8549.git
cd cloud-itonami-isic-8549
```
...
- Likely source path: `training.governor.cljc`
